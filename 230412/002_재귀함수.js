...
// 실무에서는 반복문 사용하시길 권해드립니다. 알고리즘 문제에서는 간혹 재귀를 호출해야 할 일이 있습니다. (팰린드롬, 오디오, 기러기, 우영우, 스위스, 토마토)
// (머지소트,퀵정렬) 넘어가자~
...
// 과정
//                  return                최종값
factorial(5)    5 * factoral (4)       5 * 24 == 120
factorial(4)    4 * factoral (3)       5 * 6 == 24
factorial(3)    3 * factoral (2)       5 * 24 == 6
factorial(2)    2 * factoral (1)       5 * 24 == 2
factorial(1)    1 

// 누적합 (이렇게 일일이 순회하지 않고 구할 수 있는 값이기 때문에 2개 다 비효율적인 코드입니다. 특히 소수구하는 문제 같은 곳에서 2중 for문 사용하는 것도 매우 비효율적입니다.)
result = 0
